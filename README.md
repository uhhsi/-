...
do
    python main_cifar.py -c=$config_path  --save_path=$save_path --noise_type=$noise_type --seed=$seed --gpu=$gpuid --percent=$noise_rate --dataset=$dataset --num_classes=$num_classes  --root=$data_path --model_name=disc
done
```
...
config_path='./configs/animal10N_config.py'
dataset='animal10N'
num_classes=10

python main_cifar.py -c='./configs/animal10N_config.py' --save_path=$save_path
